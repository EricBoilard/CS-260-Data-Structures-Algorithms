...
// Description : Lab 2-2 Up to Speed in C++, Part 2 CS-260, 3-15-21
//============================================================================
...
#include "CSVparser.hpp" //reference the CSVparser header library
...
vector<Bid> loadBids(string csvPath) {
    ...
    vector<Bid> bids;    //vector data structure to be used in the return and definition
...
int main(int argc, char* argv[]) {
    ...
    vector<Bid> theBids;     //vector to hold bids

    // FIXME (7a): Define a timer variable
    clock_t ticks;   //defined the timer variable
    ...
    while (choice != 9) {
        ...
        case 2:
        	...
        	ticks = clock(); //Initialize timer variable

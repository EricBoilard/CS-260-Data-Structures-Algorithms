...
// Description : This code basically uses another search method and this time it is a binary search tree
// where we complete the code to insert into a BST, search in a BST, and remove items from a BST.
//============================================================================
...
Bid BinarySearchTree::Search(string bidId) {
	...
	while (current != nullptr){
		...
		//if bid is smaller than current than go left
...
Node* BinarySearchTree::removeNode(Node* node, string bidId){
	...
	//recurse down the left side of tree

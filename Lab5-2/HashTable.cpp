...
// Name        : Eric Boilard
// Date        : April 8th 2021
// Version     : 1.0 CS-260 Data Structures and Algorithms
...
void HashTable::Insert(Bid bid) {
	...
	//turns our string obj into a basic string and then into an integer
...
Bid HashTable::Search(string bidId) {
    ...
    //walk the linked list to find the match (chaining)
    while (node != nullptr){
